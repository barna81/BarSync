...
17. Test all three buttons individually (change time signature, change divisor, trigger reset)
...
| Buttons don't respond or respond incorrectly | Check the mapping: J3=Time Sig(GPIO32), J4=Divisor(GPIO33), J5=Reset(GPIO25) |
